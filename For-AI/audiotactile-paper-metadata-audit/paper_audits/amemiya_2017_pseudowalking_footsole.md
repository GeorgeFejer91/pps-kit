# Amemiya et al. (2017 pseudo-walking foot-sole vibration)

- Record ID: `amemiya_2017_pseudowalking_footsole`
- DOI: `10.1109/WHC.2017.7989970`
- DOI URL: https://doi.org/10.1109/WHC.2017.7989970
- Coverage category: `not_yet_templated_missing_publication_parameters`
- Task family: looming-sound chest-vibrotactile detection PPS readout with pseudo-walking foot-sole vibration context
...
- extract core looming-sound timing/distance profile, chest vibrotactile target timing, response settings, trial counts, and whether the foot-sole vibration context must be represented as a secondary tactile condition for exact task execution
