...
- Record ID: `ardizzi_ferri_2018_interoceptive`
- DOI: `10.1016/j.cognition.2018.04.001`
- DOI URL: https://doi.org/10.1016/j.cognition.2018.04.001
- Coverage category: `not_yet_templated_missing_publication_parameters`
- Task family: dynamic audio-tactile PPS boundary task with interoception context
...
- extract exact audio-tactile PPS task scaffold, timing, distances, tactile settings, response settings, and analysis parameters; interoception context is non-blocking
