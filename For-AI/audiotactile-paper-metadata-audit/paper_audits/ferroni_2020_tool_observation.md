# Tool-use observation PPS (2020)

- Record ID: `ferroni_2020_tool_observation`
- DOI: `10.1016/j.neuropsychologia.2020.107622`
- DOI URL: https://doi.org/10.1016/j.neuropsychologia.2020.107622
- Coverage category: `not_yet_templated_missing_publication_parameters`
- Task family: audio-tactile PPS task around tool-use observation
...
- extract whether PPS task differs from Canzoneri-style dynamic scaffold
