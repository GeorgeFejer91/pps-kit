# Foot-sole vibration PPS remapping (2019)

- Record ID: `footsole_vibration_2019`
- DOI: `10.1177/0956797619869337`
- DOI URL: https://doi.org/10.1177/0956797619869337
- Coverage category: `not_yet_templated_missing_publication_parameters`
- Task family: looming-sound PPS tactile-processing task with foot-sole vibration context
...
- extract the core audio-tactile PPS timing, distances, trial counts, and response settings separately from the foot-sole vibration manipulation
