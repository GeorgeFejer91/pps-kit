...
- Record ID: `maister_2015_shared_sensory`
- DOI: `10.1016/j.neuropsychologia.2014.10.027`
- DOI URL: https://doi.org/10.1016/j.neuropsychologia.2014.10.027
- Coverage category: `not_yet_templated_missing_publication_parameters`
- Task family: PPS measurement after shared sensory/social context
...
- extract exact audiotactile PPS timing, distances, trial counts, tactile settings, and response settings; shared sensory/social context is non-blocking
