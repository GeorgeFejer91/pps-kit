...
- Record ID: `novel_two_phase_audio_tactile_2025`
- DOI: `not recorded`
- DOI URL: not recorded
- Coverage category: `not_yet_templated_missing_publication_parameters`
- Task family: two-phase audio-tactile PPS paradigm for defensive boundaries
...
- bibliographic identity and full task parameters need verification before templating
