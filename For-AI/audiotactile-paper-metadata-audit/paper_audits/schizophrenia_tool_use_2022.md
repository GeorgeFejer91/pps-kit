# Tool-use extends PPS boundaries in schizophrenia (2022)

- Record ID: `schizophrenia_tool_use_2022`
- DOI: `10.1093/schbul/sbac067`
- DOI URL: https://doi.org/10.1093/schbul/sbac067
- Coverage category: `not_yet_templated_missing_publication_parameters`
- Task family: audio-tactile PPS task before/after tool-use
...
- extract PPS task parameters; clinical group and tool-use context are non-blocking
