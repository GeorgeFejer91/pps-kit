# Serino et al. (2011 professional fencers)

- Record ID: `serino_2011_professional_fencers`
- DOI: `not recorded`
- DOI URL: not recorded
- Coverage category: `not_yet_templated_missing_publication_parameters`
- Task family: audio-tactile PPS task around the right hand while holding a fencing weapon or short handle
...
- conference abstract reports an audio-tactile right-hand PPS task but not enough timing, distance, tactile, response, trial-count, and weapon/handle geometry parameters for a runnable profile
