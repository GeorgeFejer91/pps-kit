# Social perception shapes multisensory PPS (2017)

- Record ID: `social_perception_2017`
- DOI: `10.1016/j.cortex.2017.08.033`
- DOI URL: https://doi.org/10.1016/j.cortex.2017.08.033
- Coverage category: `not_yet_templated_missing_publication_parameters`
- Task family: audio-tactile PPS task with social-perception context
...
- extract the core audio-tactile PPS task parameters; social perception context is non-blocking
