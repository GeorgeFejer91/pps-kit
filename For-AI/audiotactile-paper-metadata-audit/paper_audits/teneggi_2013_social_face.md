...
- Record ID: `teneggi_2013_social_face`
- DOI: `10.1016/j.cub.2013.01.043`
- DOI URL: https://doi.org/10.1016/j.cub.2013.01.043
- Coverage category: `covered_blocked_missing_publication_parameters`
- Task family: face tactile detection with approaching/receding sound labels
...
- exact distance/timing table from supplement
