...
$quickTests = @(
    "For-AI/engineering/tests/test_cli.py",
    "For-AI/engineering/tests/test_release_audit.py",
    "For-AI/engineering/tests/test_repository_structure.py",
    "For-AI/engineering/tests/test_package_inventory.py",
    "For-AI/engineering/tests/test_download_manifest.py",
    "For-AI/engineering/tests/test_qt_runtime_check.py",
    "For-AI/engineering/tests/test_runtime_paths.py",
    "For-AI/engineering/tests/test_seed_data.py",
    "For-AI/engineering/tests/test_audio_assets.py",
    "For-AI/engineering/tests/test_focus_launch.py"
)

Invoke-Step "compile Python sources" {
    & $PythonExe -m compileall -q packages/pps-runtime/src For-AI/engineering/tests For-AI/engineering/release For-AI/engineering/tooling For-AI/engineering/validation
}
...
roots = [Path('packages/pps-resources'), Path('distributions/manifests'), Path('For-AI')]
count = 0
for root in roots:
    if not root.exists():
        continue
...
Invoke-Step "release/privacy audit" {
    & $PythonExe For-AI\engineering\release\tools\release_audit.py
}
...
if ($Tier -eq "Deep") {
    ...
    if ($AllowHardware) {
        ...
        Write-Host "Run the For-AI/engineering/validation hardware scripts appropriate for the attached lab PC."
    } else {
        Write-Host ""
