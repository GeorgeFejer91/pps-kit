...
$AssetDir = Join-Path $Root "packages\pps-resources\assets\0. Head-Related Impulse Response (HRIR) model"
...
$Manifest = [ordered]@{
    ...
    file = "packages/pps-resources/assets/0. Head-Related Impulse Response (HRIR) model/FABIAN_HRIR_measured_HATO_0.sofa"
    sha256 = $Hash
    bytes = $Length
