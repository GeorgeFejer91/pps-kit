...
- Dashboard/static assets: `apps/designer/frontend/`, `apps/designer/frontend/viewer/`, root `index.html`, `.nojekyll`.
...
- Android companion source/build materials: `For-AI/experiments/android-companion/runner-companion/` and `For-AI/experiments/android-companion/tooling/Build_Android_Companion.ps1`.
- Windows launchers and build/audit helpers needed to inspect the installation.
- `For-AI/engineering/release/protocols/` so installer package decisions and missing links are visible in the installed package.
