...
OUTCOME_PATH = ROOT / "For-AI" / "research" / "literature" / "preload-ledgers" / "audiotactile_expected_outcome_coverage.json"
BUILDER_PATH = ROOT / "For-AI" / "research" / "literature" / "tools" / "build_expected_outcome_coverage.py"
...
def test_expected_outcome_coverage_matches_literature_records_and_builder():
    ...
    assert outcome["source_literature_coverage"] == "For-AI/research/literature/preload-ledgers/audiotactile_literature_coverage.json"
                ...
                if record_id == "biggio_2017_racket_tool_use"
                    ...
                    if record_id == "noel_2015_walking"
                        ...
                        if record_id == "canzoneri_2013_amputation_prosthesis"
                            ...
                            if record_id == "serino_2015_toolless_sync_training"
                            else (
