...
PIPELINE_PATH = ROOT / "For-AI" / "research" / "literature" / "preload-ledgers" / "audiotactile_full_pipeline_validation.json"
BUILDER_PATH = ROOT / "For-AI" / "research" / "literature" / "tools" / "build_full_pipeline_validation_coverage.py"
...
def test_full_pipeline_validated_records_pass_every_required_gate():
    ...
    canzoneri_amputation = records["canzoneri_2013_amputation_prosthesis"]
    assert canzoneri_amputation["full_emulated_pipeline_validated"]
