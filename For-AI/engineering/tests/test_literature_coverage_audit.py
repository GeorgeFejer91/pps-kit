...
COVERAGE_PATH = ROOT / "For-AI" / "research" / "literature" / "preload-ledgers" / "audiotactile_literature_coverage.json"
HOLMES_PATH = ROOT / "For-AI" / "research" / "literature" / "preload-ledgers" / "audiotactile_holmes2020_consensus_screening.json"
OPENALEX_PATH = ROOT / "For-AI" / "research" / "literature" / "preload-ledgers" / "audiotactile_openalex_broad_screening.json"
OPENALEX_CANDIDATE_SCREENING_PATH = (
    ROOT / "For-AI" / "research" / "literature" / "preload-ledgers" / "audiotactile_openalex_candidate_screening.json"
)
OPENALEX_QUERY_VARIANT_SCREENING_PATH = (
    ROOT / "For-AI" / "research" / "literature" / "preload-ledgers" / "audiotactile_openalex_query_variant_screening.json"
)
PUBMED_QUERY_VARIANT_SCREENING_PATH = (
    ROOT / "For-AI" / "research" / "literature" / "preload-ledgers" / "audiotactile_pubmed_query_variant_screening.json"
)
WEB_SANITY_SCREENING_PATH = (
    ROOT / "For-AI" / "research" / "literature" / "preload-ledgers" / "audiotactile_web_sanity_screening.json"
)
PUBMED_ABSTRACTS_PATH = ROOT / "artifacts" / "literature_audit" / "pubmed_missing_screen_abstracts.json"
SCREENING_PATH = ROOT / "For-AI" / "research" / "literature" / "preload-ledgers" / "audiotactile_pubmed_screening.json"
STATUS_PATH = ROOT / "packages" / "pps-resources" / "assets" / "preloads" / "profile_recreation_status.json"
...
def test_literature_coverage_ledger_matches_current_template_inventory():
    ...
    assert any(
        source.get("screening_file") == "For-AI/research/literature/preload-ledgers/audiotactile_pubmed_screening.json"
    ...
    assert any(
        source.get("broad_screening_file") == "For-AI/research/literature/preload-ledgers/audiotactile_openalex_broad_screening.json"
        for source in coverage["evidence_sources"]
    )
    assert any(
        source.get("candidate_screening_file")
        == "For-AI/research/literature/preload-ledgers/audiotactile_openalex_candidate_screening.json"
        for source in coverage["evidence_sources"]
    )
    assert any(
        source.get("screening_file")
        == "For-AI/research/literature/preload-ledgers/audiotactile_openalex_query_variant_screening.json"
        for source in coverage["evidence_sources"]
    )
    assert any(
        source.get("screening_file")
        == "For-AI/research/literature/preload-ledgers/audiotactile_pubmed_query_variant_screening.json"
        for source in coverage["evidence_sources"]
    )
    assert any(
        source.get("screening_file")
        == "For-AI/research/literature/preload-ledgers/audiotactile_web_sanity_screening.json"
        for source in coverage["evidence_sources"]
    )
    assert any(
