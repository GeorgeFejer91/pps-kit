...
def _load_audit_module():
    script_path = REPO_ROOT / "For-AI/engineering/validation" / "scripts" / "run_static_dashboard_preview_parity_audit.py"
...
def test_dashboard_static_preview_audit_hook_is_query_gated():
    app_js = (REPO_ROOT / "apps" / "designer" / "frontend" / "app.js").read_text(encoding="utf-8")
...
def test_static_dashboard_preview_parity_audit_targets_all_previewable_profiles():
    ...
    status = module.load_profile_recreation_status(module.RESOURCE_ROOT)
    ...
    assert module.dashboard_audit_url("https://georgefejer91.github.io/pps-kit/") == (
        "https://georgefejer91.github.io/pps-kit/apps/designer/frontend/index.html"
