...
```powershell
.\.venv\Scripts\python.exe For-AI/engineering/validation\scripts\run_lsl_command_ack_roundtrip.py --count 10
```
...
`For-AI/experiments/android-companion/runner-companion/app/libs/liblsl-Android.aar` is supplied for a
...
Use `For-AI/experiments/android-companion/validation/validate_android_lsl_runtime_artifact.py` on
...
python For-AI/experiments/android-companion/validation/validate_android_lsl_runtime_artifact.py artifacts/android_lsl_monitor --expect-native-transport --expect-command-acks
```
...
```powershell
python For-AI/experiments/android-companion/validation/reconcile_android_lsl_monitor_with_phone_run.py <phone-run-dir-or-zip> artifacts/android_lsl_monitor --expect-numeric-triggers --expect-command-acks
```
...
```powershell
python For-AI/experiments/android-companion/validation/reconcile_android_command_admin_with_phone_run.py <phone_controller_or_pc_admin_outbox_or_dir> <phone-run-dir-or-zip> --expect-native-sends --expect-command-acks
```
