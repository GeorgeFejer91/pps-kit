...
python .\For-AI/engineering/validation\scripts\lsl_marker_probe.py --stream-name PPSMarkersV2 --duration-s 15 --expected-count 104
python .\For-AI/engineering/validation\scripts\lsl_marker_probe.py --stream-name PPSTriggerCodes --duration-s 15 --expected-count 104
python .\For-AI/engineering/validation\scripts\compare_response_timing_strategies.py `
...
```powershell
python .\For-AI/engineering/validation\scripts\run_visible_runner_os_click_stress.py `
...
```powershell
python .\For-AI/engineering/validation\scripts\emulate_mouse_clicks.py --count 10 --interval-s 0.5 --start-delay-s 2 --armed
```
