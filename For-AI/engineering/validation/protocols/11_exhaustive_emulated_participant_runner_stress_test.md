...
```powershell
python .\For-AI/engineering/validation\scripts\run_full_realtime_participant_emulation.py `
  --participant-id P001 `
...
python .\For-AI/engineering/validation\scripts\run_study5_end_to_end_ui_mouse_validation.py `
  --packaged-standalone-app

python .\For-AI/engineering/validation\scripts\run_focus_runner_layout_validation.py `
  --offscreen `
...
python .\For-AI/engineering/validation\scripts\run_topup_missed_trial_stress.py `
...
```powershell
python .\For-AI/engineering/validation\scripts\run_desktop_full_mock_rehearsal.py `
...
```powershell
python .\For-AI/engineering/validation\scripts\audit_full_session_wired_lsl_xdf_drift.py `
...
`apps/runner/launchers/focus_runner_entry.py`, but it does not satisfy the packaged-runner
launch requirement.
...
```powershell
python .\For-AI/engineering/validation\scripts\run_protocol11_controlled_response_matrix.py `
...
```powershell
python .\For-AI/engineering/validation\scripts\run_protocol11_capture_options_matrix.py `
...
```powershell
python .\For-AI/engineering/validation\scripts\validate_protocol11_emulated_runner_artifacts.py `
...
```powershell
python .\For-AI/engineering/validation\scripts\audit_protocol11_study5_readiness.py `
