...
def build_audit(artifact_paths: dict[str, Path]) -> dict[str, Any]:
    ...
    rows.append(
        _criterion(
            ...
            "proven",
            "For-AI/engineering/validation/ contains manual protocols/scripts/reports and no public package entry point was added for these stress protocols.",
            Path("For-AI/engineering/validation"),
        )
    )
    ...
    rows.append(
        _criterion(
            ...
            artifact_paths["visible_runner_os_click"] if visible_runner_click else Path("For-AI/engineering/validation/protocols/05_emulated_mouse_click_timing.md"),
    ...
    rows.append(
        _criterion(
            ...
            artifact_paths["actual_condition_one_block"] if actual_condition_one_block else Path("For-AI/engineering/validation/protocols/07_one_block_actual_experimental_condition_validation.md"),
    ...
    rows.append(
        _criterion(
            ...
            artifact_paths["actual_block_loopback"] if actual_block_loopback else Path("For-AI/engineering/validation/scripts/compare_actual_block_loopback.py"),
    ...
    rows.append(
        _criterion(
            ...
            recording_alignment_path if recording_alignment else Path("For-AI/engineering/validation/protocols/09_recording_layer_alignment_validation.md"),
    ...
    response_loopback_script = Path("For-AI/engineering/validation/scripts/compare_response_marker_loopback.py")
    rows.append(
        _criterion(
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("For-AI/engineering/validation/reports/evidence_audit"))
