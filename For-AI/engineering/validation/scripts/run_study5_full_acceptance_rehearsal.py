        ...
        build = _run_command(
            ...
            [
                ...
                str(
                    ...
                    / "build"
                    / "windows"
                    / "Build_Experiment_Runner_Exe.ps1"
                ),
            ],
...
def _run_static_gates(commands_dir: Path, gates: list[dict[str, Any]]) -> bool:
    pytest_gate = _run_command(
        ...
        [
            ...
            "tests/test_For-AI/engineering/validation.py::test_desktop_full_mock_rehearsal_delegates_to_full_stack_harness",
            "tests/test_For-AI/engineering/validation.py::test_desktop_full_mock_rehearsal_uses_runner_owned_labrecorder",
            "tests/test_For-AI/engineering/validation.py::test_study5_baseline_no_looming_metrics_require_instruction_audio",
            "tests/test_For-AI/engineering/validation.py::test_study5_prepared_block_audit_flags_baseline_silent",
            "-q",
        ],
        commands_dir=commands_dir,
        timeout_s=900,
