...
```text
For-AI/experiments/android-companion/runner-companion/app/libs/liblsl-Android.aar
```
...
2. Artifact validator:
   `python For-AI/experiments/android-companion/validation/validate_android_lsl_runtime_artifact.py <phone-run-dir>`.
...
```powershell
.\.venv\Scripts\python.exe For-AI/engineering/validation\scripts\validate_android_lsl_runtime_artifact.py <phone-run-dir> --expect-native-transport
```
...
```powershell
.\.venv\Scripts\python.exe For-AI/engineering/validation\scripts\validate_android_lsl_runtime_artifact.py <phone-run-dir-or-zip> --expect-run-catalog
```
...
```powershell
.\.venv\Scripts\python.exe For-AI/engineering/validation\scripts\validate_android_lsl_runtime_artifact.py <phone-run-dir-or-zip> --expect-run-catalog --expect-lightweight-materializations
```
...
```powershell
.\.venv\Scripts\python.exe For-AI/engineering/validation\scripts\validate_android_lsl_runtime_artifact.py <phone_controller_command_outbox.jsonl> --expect-native-transport --expect-command-acks
```
...
```powershell
.\.venv\Scripts\python.exe For-AI/engineering/validation\scripts\reconcile_android_command_admin_with_phone_run.py <phone_controller_command_outbox.jsonl-or-dir> <phone-run-dir-or-zip> --expect-native-sends --expect-command-acks
```
...
```powershell
.\.venv\Scripts\python.exe For-AI/engineering/validation\scripts\validate_android_lsl_runtime_artifact.py <pc_android_lsl_command_outbox.jsonl> --expect-native-transport --expect-command-acks
```

Use the same sender/receiver reconciliation for PC-admin rehearsals:

```powershell
.\.venv\Scripts\python.exe For-AI/engineering/validation\scripts\reconcile_android_command_admin_with_phone_run.py <pc_android_lsl_command_outbox.jsonl-or-dir> <phone-run-dir-or-zip> --expect-native-sends --expect-command-acks
```
...
```powershell
.\.venv\Scripts\python.exe For-AI/engineering/validation\scripts\validate_android_lsl_runtime_artifact.py artifacts\android_lsl_monitor\rehearsal_001 --expect-native-transport --expect-command-acks
```
...
```powershell
.\.venv\Scripts\python.exe For-AI/engineering/validation\scripts\reconcile_android_lsl_monitor_with_phone_run.py <phone-run-dir-or-zip> artifacts\android_lsl_monitor\rehearsal_001 --expect-numeric-triggers --expect-command-acks --output-dir artifacts\android_lsl_monitor\rehearsal_001\reconciliation
```
