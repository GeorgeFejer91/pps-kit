...
- Android native LSL integration guidance is tracked in
  ...
  is set, lightweight scheduled-block materialization
  ...
  phone-owned `phone_owned_data_export.json` plus app-private
  `phone_owned_exports/1.Data_min` and `2.Data_max` snapshots when
