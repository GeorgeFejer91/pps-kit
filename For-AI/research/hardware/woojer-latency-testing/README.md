...
```powershell
python .\For-AI/research/hardware/woojer-latency-testing\scripts\run_woojer_audio_loopback_stress.py --mode direct-baseline
```

Run the Woojer loop and subtract the direct baseline median:

```powershell
python .\For-AI/research/hardware/woojer-latency-testing\scripts\run_woojer_audio_loopback_stress.py --mode woojer-loop --baseline-run .\For-AI/research/hardware/woojer-latency-testing\runs\direct-baseline_YYYYMMDD_HHMMSS
```

Append the result to the tracked LaTeX log:

```powershell
python .\For-AI/research/hardware/woojer-latency-testing\scripts\run_woojer_audio_loopback_stress.py --mode woojer-loop --baseline-run .\For-AI/research/hardware/woojer-latency-testing\runs\direct-baseline_YYYYMMDD_HHMMSS --append-tex-log
```
...
Each run writes a timestamped folder under `For-AI/research/hardware/woojer-latency-testing/runs/`:
