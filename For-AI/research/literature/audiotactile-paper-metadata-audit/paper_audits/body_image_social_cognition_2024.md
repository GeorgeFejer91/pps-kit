# Body image and social cognition PPS task (2024)

- Record ID: `body_image_social_cognition_2024`
- DOI: `10.1016/j.bodyim.2024.101777`
- DOI URL: https://doi.org/10.1016/j.bodyim.2024.101777
- Coverage category: `not_yet_templated_missing_publication_parameters`
- Task family: audio-tactile reaction-time PPS boundary task used alongside interpersonal-distance measures
- PDF status: `open_access_unavailable`
- Supplement status: `needs_user_download`
- Supplement acquisition attempts: `5` (`http_400`)
...
- extract exact audio-tactile reaction-time task parameters; body-image/social-cognition variables are non-blocking context
