...
LEDGER_ROOT = REPO_ROOT / "For-AI" / "research" / "literature" / "preload-ledgers"
AUDIT_ROOT = REPO_ROOT / "For-AI" / "research" / "literature" / "audiotactile-paper-metadata-audit"
RESOURCE_ROOT = REPO_ROOT / "packages" / "pps-resources"
COVERAGE_PATH = LEDGER_ROOT / "audiotactile_literature_coverage.json"
EXPECTED_OUTCOME_PATH = LEDGER_ROOT / "audiotactile_expected_outcome_coverage.json"
PROFILE_STATUS_PATH = RESOURCE_ROOT / "assets" / "preloads" / "profile_recreation_status.json"
PAPER_AUDIT_PATH = AUDIT_ROOT / "metadata_audit.jsonl"
MANUAL_REVIEW_INDEX_PATH = (
    AUDIT_ROOT / "manual_review_index.csv"
)
OUTPUT_PATH = LEDGER_ROOT / "audiotactile_full_pipeline_validation.json"
...
def build_full_pipeline_validation() -> dict[str, Any]:
    ...
    return {
        ...
        "source_ledgers": {
            "literature_coverage": "For-AI/research/literature/preload-ledgers/audiotactile_literature_coverage.json",
            "expected_outcome_coverage": "For-AI/research/literature/preload-ledgers/audiotactile_expected_outcome_coverage.json",
            "profile_recreation_status": "assets/preloads/profile_recreation_status.json",
            "paper_metadata_audit": "For-AI/research/literature/audiotactile-paper-metadata-audit/metadata_audit.jsonl",
