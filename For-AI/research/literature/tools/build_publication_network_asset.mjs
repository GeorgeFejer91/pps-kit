...
const DEFAULT_SNAPSHOT = path.join(
  REPO_ROOT,
  "For-AI/research/literature/publication-network/citation_snapshot.v1.json",
);
...
const CITATION_OVERLAY_PATHS = [
  "For-AI/research/literature/publication-network/openalex_audiotactile_citation_overlay.20260808.json",
  "For-AI/research/literature/publication-network/primary_source_citation_overlay.20260808.json",
...
const MANUAL_REVIEW_DIR = path.join(
  REPO_ROOT,
  "For-AI/research/literature/audiotactile-paper-metadata-audit/manual_reviews",
);
