...
DESIGN_SOURCE = REPO_ROOT / "packages/pps-runtime/src/peripersonal_space_toolkit/design.py"
TEMPLATE_SOURCE = REPO_ROOT / "packages/pps-runtime/src/peripersonal_space_toolkit/templates.py"
...
def _template_alias_metadata(source_path: Path = TEMPLATE_SOURCE) -> dict[str, dict[str, Any]]:
    ...
    for serialized_path, (template_path, template_required) in TEMPLATE_FIELD_ALIASES.items():
        ...
        metadata[serialized_path] = {
            ...
            "template_parser_source_file": source_path.relative_to(REPO_ROOT).as_posix(),
...
def schema_document() -> dict[str, Any]:
    return {
        ...
        "source_file": DESIGN_SOURCE.relative_to(REPO_ROOT).as_posix(),
