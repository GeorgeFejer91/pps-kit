...
func run(args []string) int {
	flags := flag.NewFlagSet(productName+" Downloader", flag.ContinueOnError)
	...
	launch := flags.Bool("launch", false, "Launch the installed application after installation.")
	...
	fmt.Printf("Installed %s %s at %s\n", productName, result.Manifest.Version, result.InstallDir)
