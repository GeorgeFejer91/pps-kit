...
| Serino et al. (2007) | static near/far weak-target Go/NoGo tactile detection | Not templated; toolkit structure gap | Toolkit/task constraints: `weak_strong_no_target_gonogo`, `voice_key_response_capture`, `electrical_tactile_calibration` Missing/extract: full calibration and response-capture implementation details need extraction |
...
| Bassolino et al. (2010) | static near/far tactile detection around hand/tool space | Not templated; toolkit structure gap | Toolkit/task constraints: `weak_strong_no_target_gonogo` Missing/extract: full trial counts, tactile calibration, and response mapping need extraction |
| Serino et al. (2011) | static near/far audio-tactile PPS task with rTMS context | Not templated; toolkit structure gap | Toolkit/task constraints: `weak_strong_no_target_gonogo` Missing/extract: full audio, tactile, and response settings need extraction |
...
| Cimmino et al. (2013) | static near/far audio-tactile PPS task | Not templated; toolkit structure gap | Toolkit/task constraints: `weak_strong_no_target_gonogo` Missing/extract: full audio/tactile/timing parameters need extraction |
...
| Holmes et al. (2020), four experiments | static near/far sounds paired with weak vibrotactile targets and Go/NoGo response logic | Not templated; toolkit structure gap | Toolkit/task constraints: `weak_strong_no_target_gonogo` Missing/extract: task is publicly documented but needs weak/strong/no-target response logic and exact profile translation |
...
| Serino et al. 2007 | Static near/far weak-target Go/NoGo tactile detection | Stationary near/far source rows are supported; remaining gaps are weak/strong/no-target trial logic, voice response, tactile calibration, and exact timing parameters. |
...
| Bassolino et al. 2010; Cimmino et al. 2013 | Static near/far hand/tool-space PPS tasks | Stationary near/far source rows are supported; remaining gaps are weak/strong/no-target logic and exact method extraction. |
...
| Holmes et al. 2020 four experiments | Static near/far sounds paired with weak vibrotactile targets and Go/NoGo logic | Stationary near/far source rows are supported; remaining gap is weak/strong/no-target task support plus exact profile translation. |
