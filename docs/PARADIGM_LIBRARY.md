...
| `serino_2015_toolless_sync_training.json` | partial | Synchronous/asynchronous far-audio and hand-tactile training scaffold with Canzoneri-family PPS measurement. | Electrocutaneous tactile calibration source values still need extraction; training context is non-blocking unless it changes task timing. |
