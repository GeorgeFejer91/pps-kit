...
| `canzoneri_2013_amputation_prosthesis.json` | partial | Clinical amputation/prosthesis PPS scaffold using the dynamic audio-tactile task family. | Exact trial count, ITI/baseline/repetition details, and tactile calibration table still need extraction; clinical group, prosthesis-worn state, and tested-limb assignment are metadata only. |
