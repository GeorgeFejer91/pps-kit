...
def build_profile_parameters_manifest(
    ...
    *,
    ...
    return {
        ...
        "publication_status": str(template.reference_parameters.get("publication_status") or "published"),
        "profile_type": str(template.reference_parameters.get("profile_type") or ""),
...
def profile_summary_from_manifest(manifest: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "publication_status": manifest.get("publication_status", "published"),
...
def _segment_artifact_summary(profile_dir: Path, source_assets: list[dict[str, Any]], design: StimulusDesign) -> dict[str, Any]:
    return {
        ...
        "local_segment_1_to_6_materialization": {
            ...
            "tool": "For-AI/engineering/tooling/materialize_profile_segments.py",
