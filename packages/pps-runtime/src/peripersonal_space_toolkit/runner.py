...
if __name__ == "__main__":
    ...
    print(
        ...
        "`dist\\PPSExperimentRunner\\PPSExperimentRunner.exe` or "
...
from .runtime_paths import resource_root, writable_root
...
STIMULI_DIR = str(WRITABLE_ROOT / "artifacts" / "stimuli" / "10.Participant_Sequences")
...
TACTILE_TEST_STIMULUS = str(WRITABLE_ROOT / "artifacts" / "stimuli" / "1. TactileStimuli" / "tactile_stimulus_0ms.wav")
...
SETTINGS_FILE = str(WRITABLE_ROOT / "local_data" / "experiment_settings.json")

# Demographics data folder
DEMOGRAPHICS_DIR = str(WRITABLE_ROOT / "local_data" / "demographics")

# Loopback recording output folder
RECORDINGS_DIR = str(WRITABLE_ROOT / "local_data" / "loopback_recordings")
