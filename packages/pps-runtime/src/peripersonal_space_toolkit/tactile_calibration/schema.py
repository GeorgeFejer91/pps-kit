...
VALID_RESPONSE_START_MS = TACTILE_RESPONSE_MIN_RT_S * 1000.0
VALID_RESPONSE_END_MS = TACTILE_RESPONSE_MAX_RT_S * 1000.0

TACTILE_OUTPUT_34_MAX_PERCENT = 0.7
TACTILE_OUTPUT_34_HARD_GUARD_PERCENT = 1.0
...
CALIBRATION_MAX_FALSE_ALARMS = 3
STAIRCASE_MAX_FALSE_ALARMS = CALIBRATION_MAX_FALSE_ALARMS
CONFIRMATION_REQUIRED_CONSECUTIVE_HITS = 10
CONFIRMATION_REQUIRED_CLEAN_CATCHES = 5
CONFIRMATION_LEVEL_INCREMENT_PERCENT = 0.01
