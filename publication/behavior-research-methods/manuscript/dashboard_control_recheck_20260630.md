...
- `src/peripersonal_space_toolkit/dashboard/app.js`
- `src/peripersonal_space_toolkit/dashboard/styles.css`
- `publication/behavior-research-methods/manuscript/gui_control_coverage.csv`
