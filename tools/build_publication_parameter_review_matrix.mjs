...
const AUDIT_DIR = path.join(REPO_ROOT, "For-AI/audiotactile-paper-metadata-audit");
...
for (const [segmentKey, fields] of Object.entries(extractionSchema.segment_fields || {})) {
  ...
  for (const field of fields) {
    publicationParameters.push({
      ...
      sourcePath: "For-AI/audiotactile-paper-metadata-audit/extraction_schema.json",
    });
  }
}
