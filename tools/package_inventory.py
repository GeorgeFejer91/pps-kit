...
INVENTORY_ITEMS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "kind": "generated_binary",
        "role": "packaged offline/local HTML dashboard and companion launcher",
        "required": True,
        "source": "built by windows/Build_Dashboard_Launcher_Exe.ps1",
    },
    {
        "path": "dist/PPSDashboardLauncher",
        "kind": "generated_directory",
        "role": "PyInstaller onedir dashboard launcher resources",
        "required": True,
        "source": "built by windows/Build_Dashboard_Launcher_Exe.ps1",
    },
    {
    ...
    {
        "path": "windows/Build_Dashboard_Launcher_Exe.ps1",
        "kind": "launcher_build_script",
        "role": "builds PPSDashboardLauncher.exe",
        "required": True,
        "source": "tracked",
    },
    {
    ...
    {
        "path": "installer_protocols",
        "kind": "installer_protocol_tree",
        "role": "release build, content orchestration, verification, and missing-link protocols",
        "required": True,
        "source": "tracked",
    },
    {
