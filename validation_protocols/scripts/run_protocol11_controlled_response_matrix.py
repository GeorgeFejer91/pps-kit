...
def _trial_specs() -> list[dict[str, Any]]:
    return [
        ...
        {
            "scenario_label": "click_at_next_trial_start_rejects_previous",
            "family": "audio_tactile",
            "duration_s": 0.420,
            "soa_ms": 100,
            "row_label": "Exhale",
        ...
        {
            "scenario_label": "boundary_3000ms_accept",
            "family": "audio_tactile",
            "duration_s": 3.250,
            "soa_ms": 0,
            "row_label": "Exhale",
            "action": "boundary_accept",
            "expected_hit": True,
            "planned_rt_ms": 3000.0,
            "clicks": [{"delay_ms": 3000.0, "in_target": True}],
        },
        {
            "scenario_label": "late_3100ms_reject",
            "family": "audio_tactile",
            "duration_s": 3.250,
            "soa_ms": 0,
            "row_label": "Inhale",
            "action": "late",
            "expected_hit": False,
            "clicks": [{"delay_ms": 3100.0, "in_target": True}],
        },
    ]
...
def run_matrix(
    *,
    ...
    checks = {
        ...
        "next_trial_start_click_rejected_previous": not _truthy(by_uid[plan_trials[6]["trial_uid"]].get("hit")),
        "max_3000ms_accepted": _truthy(by_uid[plan_trials[8]["trial_uid"]].get("hit")),
        "late_3100ms_rejected": not _truthy(by_uid[plan_trials[9]["trial_uid"]].get("hit")),
